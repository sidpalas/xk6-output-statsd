...
func (o *Output) Start() error {
	...
	o.client, err = statsd.New(o.config.Addr.String, statsd.WithNamespace(o.config.Namespace.String), statsd.WithMaxMessagesPerPayload(int(o.config.BufferSize.Int64)))
